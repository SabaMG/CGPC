...
interface SelecteurCategoriesProps {
    ...
    currentCategoryId?: string; // ID de la catégorie actuelle
...
// Fonction pour trouver le chemin d'une catégorie dans l'arborescence
...
const SelecteurCategories: React.FC<SelecteurCategoriesProps> = ({
    ...
    if (!categoryTree) {
        return <div>{t('loading_categories')}</div>;
    }
