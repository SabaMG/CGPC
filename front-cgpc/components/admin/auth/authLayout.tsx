            ...
            <div className="hidden md:flex flex-1 relative flex items-center justify-center p-6">
                ...
                <div className="z-10">
                    ...
                    <div className="font-light text-slate-400 mt-4">
                        ...
                        Quasi possimus voluptate, sapiente assumenda deserunt
                        repellendus, perferendis odit voluptas hic dolores
                        laborum fugit ut? Architecto quo ex quidem vitae quae
                        rem.
                    </div>
                </div>
            </div>
